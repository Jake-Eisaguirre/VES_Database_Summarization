...
- Attempt 3-annual survey period
  - Summer to early fall
  - 7 sites which get surveyed twice a year 3 days in row (attempted)
...
- Attempt bi-annual survey period
- Only have Boraceia VES data, Santa Virginia being collected now.
- VES data is identical to Capture data as all orgs spotted along transect were captured. 